...
export default function AboutPage() {
  ...
  const content = {
    ar: {
      ...
      archValue: "ConvNeXt-Tiny (Calibrated SOTA Architecture)",
      datasetSizeLabel: "حجم مجموعة البيانات",
      datasetSizeValue: "63,629 صورة جلدية موحدة ومتنوعة الأعراق",
      engineLabel: "محرك التشخيص المحلي",
      engineValue: "Google LiteRT.js (WebGPU Accelerated + WASM SIMD, 2-Pass TTA)",
      privacyLabel: "معيار الخصوصية",
      privacyValue: "معالجة محلية 100% (Zero Cloud Leakage)",
      lossLabel: "دالة الخسارة والمعايرة السريرية",
      lossValue: "Inverse-Square-Root Class-Weighted Focal Loss (γ = 1.5)",
      ...
      melValue: "73.2%",
      balAccLabel: "الدقة المتوازنة (Balanced Accuracy)",
      balAccValue: "64.8%",
