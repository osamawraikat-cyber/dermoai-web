...
export default function AboutPage() {
  ...
  const content = {
    ar: {
      ...
      specsTitle: "المواصفات التقنية للهندسة البرمجية",
      archLabel: "شبكة الذكاء الاصطناعي",
      archValue: "ConvNeXt-Tiny (Deep Convolutional Network)",
      datasetSizeLabel: "حجم مجموعة البيانات",
      datasetSizeValue: "63,629 صورة جلدية متعددة المصادر والأعراق",
      engineLabel: "محرك التشخيص المحلي",
      engineValue: "Google LiteRT.js (TFLite Dynamic Range Quantized)",
      privacyLabel: "معيار الخصوصية",
      privacyValue: "معالجة محلية 100% (Zero Server Upload / Offline Capable)",
      lossLabel: "دالة الخسارة المتقدمة",
      lossValue: "Multi-Class Focal Loss (γ = 2.0) مع أوزان ديناميكية للأمراض النادرة",
    ...
    en: {
      ...
      specsTitle: "AI Model & Engine Specifications",
      archLabel: "Neural Architecture",
      archValue: "ConvNeXt-Tiny (Deep Convolutional Vision Network)",
      datasetSizeLabel: "Dataset Scale",
      datasetSizeValue: "63,629 Multi-Source & Multi-Skintone Images",
      ...
      lossValue: "Multi-Class Focal Loss (γ = 2.0) with Dynamic Class Weighting",
