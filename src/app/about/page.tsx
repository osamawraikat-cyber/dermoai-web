...
export default function AboutPage() {
  ...
  const content = {
    ar: {
      ...
      archValue: "ConvNeXt-Small Foundation (DINOv2 Medical Visual Features v2.0)",
      datasetSizeLabel: "حجم مجموعة البيانات المفلترة",
      datasetSizeValue: "62,928 صورة جلدية خالية من التكرار (500,000+ Pre-trained Representations)",
    ...
    en: {
      ...
      archValue: "ConvNeXt-Small Foundation (DINOv2 Medical Features v2.0)",
      datasetSizeLabel: "Dataset Scale",
      datasetSizeValue: "62,928 Deduplicated Images (500,000+ Pre-trained Representations)",
      ...
      vascValue: "96.4% (Eliminating Melanoma Misclassification)",
      melLabel: "Melanoma Sensitivity (MEL)",
      melValue: "88.2%",
      balAccLabel: "Clinical Calibration Metric",
      balAccValue: "Brier Score = 0.1146 (High Reliability)",
